...
export default function RegisterOtpScreen() {
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            ...
            router.push({ pathname: "/register-name", params: { phone } });
        } catch (error: any) {
        ...
        <SafeAreaView edges={["top", "bottom"]} style={styles.container}>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.content}>
                ...
                <Text style={styles.subtitle}>
                    Đang gửi đến số <Text style={{fontWeight: "bold"}}>{phone || "của bạn"}</Text>. Mở Console Docker để nhận mã gồm 6 số.
                </Text>
                ...
                <TouchableOpacity style={styles.resendLink} disabled={isLoading}>
                    <Text style={styles.resendText}>Bạn không nhận được mã? <Text style={styles.linkTextGray}>Gửi lại (57s)</Text></Text>
                </TouchableOpacity>
