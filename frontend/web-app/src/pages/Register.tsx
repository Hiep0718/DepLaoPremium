...
import { Phone, Lock, UserPlus, User } from 'lucide-react';
    ...
    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
      ...
      <div>
        ...
        >
          ...
          <span className="relative z-10">{loading ? 'Đang xử lý...' : 'Đăng ký tài khoản'}</span>
        </button>
      </div>
